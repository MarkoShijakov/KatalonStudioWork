...
WebUI.setText(findTestObject('Search cars Page/Search input fld'), 'Alabama USA')
...
//    WebUI.scrollToElement(findTestObject('Object Repository/Search cars Page/Car Page/Car State'), 1)

    WebUI.verifyElementText(findTestObject('Object Repository/Search cars Page/Car Page/Car State'), 'AL')
