...
WebUI.setText(findTestObject('Search cars Page/Search input fld'), '85210')
...
for (int i = 0; i < 3; i++) {
    ...
    WebUI.scrollToElement(findTestObject('Search cars Page/Car Page/Car ZIP code'), 1)

    WebUI.verifyElementText(findTestObject('Object Repository/Search cars Page/Car Page/Car ZIP code'), '85210')
